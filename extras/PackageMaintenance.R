...
OhdsiRTools::checkUsagePackage("GDE2025antiplatelet")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/GDE2025antiplatelet.pdf")
shell("R CMD Rd2pdf ./ --output=extras/GDE2025antiplatelet.pdf")
...
ROhdsiWebApi::insertCohortDefinitionSetInPackage(fileName = "Cohorts.csv",
                                                 ...
                                                 generateStats = FALSE,
                                                 packageName = "GDE2025antiplatelet")
...
OhdsiRTools::createRenvLockFile(rootPackage = "GDE2025antiplatelet",
                                mode = "description",
